...
class AddMosToWorkstationProfileTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('workstation_profile', function (Blueprint $table) {
            $table -> removeColumn('average_latency', 8, 2 );
            $table -> removeColumn('packet_loss', 8,2 );
            $table -> removeColumn('jitter', 8, 2 );
            $table -> removeColumn('mos', 8, 2 );
        });
    }
}
