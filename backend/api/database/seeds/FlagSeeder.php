...
class FlagSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i = 0 ; $i < 5; $i++ ){
            ...
            $account = Arr::random(['Apple','Belkin', 'Anthem', 'Razer','Grabtaxi']);

            $location = Arr::random( $location_ref[$country ]);

            $isp      = Arr::random(['Globe', 'Converge', 'PLDT', 'Sky']);

            $workstation_name = "CNX".$faker -> regexify('[^A-Za-z0-9]+');

            $worker_id = rand(10000, 999999 );
            ...
            $flag_id = DB::table('redflag_dashboard')->insertGetId(
                [
                    'code_id'               => rand(1,12),
            ...
            DB::table('workstation_profile')->insert(
                [
                    ...
                    'ping'      => "Ping to  [216.58.200.78] Success Response delay = 78 ms \r\n".
                        ...
                        "Ping to  [216.58.200.78] Success Response delay = 78 ms \r\n".
                        "Ping to  [216.58.200.78] Success Response delay = 78 ms \r\n",
                    'ping_ref'  => "Ping to  [216.58.200.78] Success Response delay = 78 ms \r\n".
                        "Ping to  [216.58.200.78] Success Response delay = 78 ms \r\n".
                        "Ping to  [216.58.200.78] Success Response delay = 78 ms \r\n".
                        "Ping to  [216.58.200.78] Success Response delay = 78 ms \r\n",
                    ...
                    'tracecert_ref' => "1 | 10.52.121.252 | 4 ms \r\n" .
                            "2 | 10.52.8.4 | 2 ms \r\n".
                            "210.213.138.222.static.pldt.net \r\n".
                            "210.213.143.253.static.pldt.net \r\n".
                            "210.213.134.130.static.pldt.net \r\n".
                            ...
                            "9 | 108.170.226.115 | 49 ms \r\n".
                            "del01s08-in-f206.1e100.net \r\n",
                    'host_file' => "127.0.0.1	helpdesk-local.concentrix.com \r\n".
