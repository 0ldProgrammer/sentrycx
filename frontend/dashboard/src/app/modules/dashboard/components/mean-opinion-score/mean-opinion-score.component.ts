...
@Component({
    selector: 'mean-opinion-score',
    templateUrl: './mean-opinion-score.component.html',
    styleUrls: ['./mean-opinion-score.component.css']
})
export class MeanOpinionScoreComponent implements OnInit {
