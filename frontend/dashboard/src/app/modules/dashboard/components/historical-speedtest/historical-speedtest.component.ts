...
@Component({
    selector: 'historical-speedtest',
    templateUrl: './historical-speedtest.component.html',
    styleUrls: ['./historical-speedtest.component.css']
})
export class HistoricalSpeedtestComponent implements OnInit {
