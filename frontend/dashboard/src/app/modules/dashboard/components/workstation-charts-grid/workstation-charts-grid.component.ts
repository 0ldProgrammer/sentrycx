...
@Component({
    selector: 'workstation-charts-grid',
    templateUrl: './workstation-charts-grid.component.html'
})
export class WorkstationChartsGridComponent implements OnInit {
    @Input('data-worker-id') workerID : String;

    public isLoading : Boolean = true;
    public records : Array<IWorkstationRecord> = [];
    public HISTORICAL_FIELDS : Array<IField> =  [
        {id: 'host_ip_address', name : 'IP Address', class : 'text-left' },
